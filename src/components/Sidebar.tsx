...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex h-screen w-[264px] flex-col bg-primary-dark text-white transition-transform duration-200 lg:static lg:h-screen lg:translate-x-0 ${
